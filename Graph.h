...
public:
	...
	vector<int> FindPathDfs(int startVertexKey, int endVertexKey);

    /// find the shortest path from startVertexKey to endVertexKey with Dijkstra using std::set
    vector<int> FindShortestPathDijkstraUsingSet(int startVertexKey, int endVertexKey);
    
    /// find the shortest path from startVertexKey to endVertexKey with Bellman-Ford
    vector<int> FindShortestPathBellmanFord(int startVertexKey, int endVertexKey);
    
    vector<vector<int> > FindShortestPathFloyd();
};
